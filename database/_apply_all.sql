-- ============================================================================
-- _apply_all.sql  —  Paste-ready combined schema + migrations
-- ============================================================================
-- Apply order: schema.sql -> 0001 -> 0002 -> 0003 -> 0004 -> 0005
--
-- What this file contains (in order):
--   1. schema.sql                    — base tables, indexes, RLS policies
--   2. 0001_baseline.sql             — baseline snapshot (idempotent mirror of schema)
--   3. 0002_auth_roles_and_audit.sql — roles, private helpers, audit log, system_settings
--   4. 0003_rls_rewrite.sql          — hardened RLS, public share function
--   5. 0004_anonymous_cleanup.sql    — pg_cron job for orphaned anon accounts
--   6. 0005_cloud_sync_alignment.sql — applications notes column, constraint fixes
--
-- HOW TO USE:
...
--   3. Click "Run"
--
-- NOTE: No SQL content has been modified or reformatted. Each section is a
